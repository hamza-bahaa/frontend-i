  ...
  return (
    <>
      <div className=' pt-[80px]  wraperitem'>
        <section
          className='jumbotron breadcumb  h-[50vh]  object-cover object-center bg-cover w-full'
          style={{
            backgroundImage: `url(${image2})`
          }}
        >
          <div className=' pt-[80px] text-center items-center flex  justify-center w-ful   '>
            <div className='col-md-6 text-center flex justify-center items-center text-2xl drop-shadow-lg  transition-shadow duration-300 font-semibold'>
