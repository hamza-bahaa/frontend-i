...
import imageo from '../assets/img/bg-serv-1.jpg'
import imagep from '../assets/img/bg-serv-2.jpg'
import imagec from '../assets/img/bg-serv-3.jpg'
          ...
          <div className='row'>
            <div className='col-md-4 p-0'>
              <div className='features'>
                <div className='bg'>
                  <img src={imageo} alt='bg-features' />
                </div>
            ...
            <div className='col-md-4 p-0'>
              <div className='features'>
                <div className='bg'>
                  <img src={imagep} alt='bg-features' />
                </div>
                <div className='content'>
            ...
            <div className='col-md-4 p-0'>
              <div className='features'>
                <div className='bg'>
                  <img src={imagec} alt='bg-features' />
                </div>
                <div className='content'>
          ...
          <div className='row m-10-hor'>
            <div className='col-md-4 mt-5'>
              <div className='col-feature'>
                ...
                <div className='heading'>MODERN DESIGN</div>
                <div className='content'>
                  Curabitur mollis bibendum luctus. Duis suscipit vitae dui sed
            ...
            <div className='col-md-4 mt-5'>
              <div className='col-feature'>
                ...
                <div className='heading'>FULLY SUPPORT</div>
                <div className='content'>
                  Curabitur mollis bibendum luctus. Duis suscipit vitae dui sed
                  suscipit. Vestibulum auctor nunc vitae lectus.
                </div>
            ...
            <div className='col-md-4 mt-5'>
              <div className='col-feature'>
                ...
                <div className='heading'>MAINTENANCE SUPPORT</div>
                <div className='content'>
                  Curabitur mollis bibendum luctus. Duis suscipit vitae dui sed
                  suscipit. Vestibulum auctor nunc vitae lectus.
                </div>
            ...
            <div className='col-md-4 mt-5'>
              <div className='col-feature'>
                ...
                <div className='heading'>EXPERT DEVELOPER</div>
                <div className='content'>
                  Curabitur mollis bibendum luctus. Duis suscipit vitae dui sed
                  suscipit. Vestibulum auctor nunc vitae lectus.
                </div>
            ...
            <div className='col-md-4 mt-5'>
              <div className='col-feature'>
                ...
                <div className='heading'>COMPLIANCE SOLUTION</div>
                <div className='content'>
                  Curabitur mollis bibendum luctus. Duis suscipit vitae dui sed
                  suscipit. Vestibulum auctor nunc vitae lectus.
                </div>
